...
public class RestaurantControllerTest {
    ...
    public void testSaveRestaurant() {
        ...
        // Mock the service behavior
        when(restaurantService.add(mockRestaurant)).thenReturn(mockRestaurant);
        // Call the controller method
        ...
        // Verify that the service method was called
        verify(restaurantService, times(1)).add(mockRestaurant);
    }
    ...
    public void testFindRestaurantById() {
        ...
        RestaurantDTO mockRestaurant = new RestaurantDTO(1, "Restaurant 1", "Address 1", "city 1", "Desc 1");
        // Mock the service behavior
        when(restaurantService.findById(mockRestaurantId)).thenReturn(new RestaurantDTO(1, "Restaurant 1", "Address 1", "city 1", "Desc 1"));
        // Call the controller method
        ...
        assertEquals(mockRestaurant, response.getBody());
        // Verify that the service method was called
        verify(restaurantService, times(1)).findById(mockRestaurantId);
    }
}
